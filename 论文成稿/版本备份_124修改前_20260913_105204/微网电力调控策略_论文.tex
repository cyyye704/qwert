...
\thispagestyle{empty}\begin{center}{\zihao{2}\heiti 基于残差场景与滚动调整的微网购电及储能调控策略}\end{center}
...
\par
\begin{table}[H]\centering\caption{四问的决策条件与模型对应关系}
...
\par
\section{3 符号说明与公共约束}
\begin{table}[H]\centering\caption{主要符号与单位}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
...
\begin{table}[H]\centering\caption{问题一指定时段购电量及全天费用}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题一储能侧充放电及首末储电量（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
...
\par
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=6.0cm,keepaspectratio]{../new_figures_main/Q1_F1_optimal_dispatch.pdf}
\caption{问题一的供需曲线、充放电时段与储电量轨迹。左图将电价乘5000后与功率曲线同轴展示，背景区分充、放电时段；右图为储电量及其边界。}\end{figure}
...
\par
\begin{table}[H]\centering\caption{容量窗口与储能侧功率系数的费用节选（元）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccc}\toprule
功率系数 & 容量系数0.50 & 容量系数0.75 & 容量系数1.00\\\midrule
...
\par
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=5.7cm,keepaspectratio]{../new_figures_main/Q2_F2_uncertainty_scenarios.pdf}
\caption{典型日净负荷场景与实际轨迹。P10—P90为十条历史残差场景的经验分位带，不是经校准的概率置信区间。}\end{figure}
...
\begin{table}[H]\centering\caption{问题二统计期实际结果}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
...
\par
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=7.0cm,keepaspectratio]{../new_figures_main/Q2_F3_annual_risk_profile.pdf}
\caption{问题二在统计期内的费用组成及紧急购电分布。月份汇总和逐日记录均取实际执行结果。}\end{figure}
以下各表沿用题面表1、表2的排列：指定时段为10分钟购电量，储能按四小时窗口累计；费用为包含紧急购电的当日总费用。储能量均按微网侧计量。
\par
\begin{table}[H]\centering\caption{问题2：2025-03-20指定时段购电量与全天费用}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题2：2025-03-20储能充放电与首末储电量（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 充电量 & 放电量 & 时间段 & 充电量 & 放电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题2：2025-06-21指定时段购电量与全天费用}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 购电量 & 时间段 & 购电量 & 时间段 & 购电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题2：2025-06-21储能充放电与首末储电量（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 充电量 & 放电量 & 时间段 & 充电量 & 放电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题2：2025-09-23指定时段购电量与全天费用}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 购电量 & 时间段 & 购电量 & 时间段 & 购电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题2：2025-09-23储能充放电与首末储电量（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 充电量 & 放电量 & 时间段 & 充电量 & 放电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题2：2025-12-21指定时段购电量与全天费用}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 购电量 & 时间段 & 购电量 & 时间段 & 购电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题2：2025-12-21储能充放电与首末储电量（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 充电量 & 放电量 & 时间段 & 充电量 & 放电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题二四个典型日紧急购电（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccccc}\toprule
03-20 & 购电量 & 06-21 & 购电量 & 09-23 & 购电量 & 12-21 & 购电量\\\midrule
...
\par
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=4.5cm,keepaspectratio]{../new_figures_main/Q3_F1_rolling_timeline.pdf}
\caption{0时制定原计划，6、12、18时用新预报和实测储电量优化当日剩余时段；每段采用最近一次可用计划。}\end{figure}
\subsection{6.3 预报效果与运行费用}
\begin{table}[H]\centering\caption{各发布时间光伏预测MAE（kW；按该次发布剩余时段评价）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lcccc}\toprule
发布时间 & 附件3 & 历史预测 & 组合预测 & 组合后比例修正\\\midrule
...
\par
\begin{table}[H]\centering\caption{问题二与问题三主方案的统计期比较}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lcc}\toprule
指标 & 问题二 & 问题三\\\midrule
统计天数/d & 334 & 334\\
...
\begin{table}[H]\centering\caption{更新时点和日前追索的方案比较}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccc}\toprule
方案 & 总费用/万元 & 紧急购电量/kWh & 日前追索\\\midrule
...
\par
\begin{table}[H]\centering\caption{问题3：2025-03-20指定时段购电量与全天费用（原/终）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 购电量 & 时间段 & 购电量 & 时间段 & 购电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题3：2025-03-20储能充放电与首末储电量（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 充电量 & 放电量 & 时间段 & 充电量 & 放电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题3：2025-06-21指定时段购电量与全天费用（原/终）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 购电量 & 时间段 & 购电量 & 时间段 & 购电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题3：2025-06-21储能充放电与首末储电量（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 充电量 & 放电量 & 时间段 & 充电量 & 放电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题3：2025-09-23指定时段购电量与全天费用（原/终）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 购电量 & 时间段 & 购电量 & 时间段 & 购电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题3：2025-09-23储能充放电与首末储电量（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 充电量 & 放电量 & 时间段 & 充电量 & 放电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题3：2025-12-21指定时段购电量与全天费用（原/终）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 购电量 & 时间段 & 购电量 & 时间段 & 购电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题3：2025-12-21储能充放电与首末储电量（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 充电量 & 放电量 & 时间段 & 充电量 & 放电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题三四个典型日紧急购电（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccccc}\toprule
03-20 & 购电量 & 06-21 & 购电量 & 09-23 & 购电量 & 12-21 & 购电量\\\midrule
...
\par
\begin{table}[H]\centering\caption{因果价格预测误差（元/kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lcc}\toprule
发布时间 & MAE & RMSE\\\midrule
...
\par
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=5.4cm,keepaspectratio]{../new_figures_main/Q4_F2_price_forecast_update.pdf}
\caption{实际电价与不同发布时间的价格预测。更新仅使用发布时间之前的实际电价。}\end{figure}
\subsection{7.2 统计期费用与信息价值}
\begin{table}[H]\centering\caption{波动电价下两种因果方案的统计期结果}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lcc}\toprule
指标 & 问题四之二 & 问题四之三\\\midrule
统计天数/d & 334 & 334\\
...
\par
\begin{table}[H]\centering\caption{统一按实际电价结算的价格信息对照（万元）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lcc}\toprule
信息条件 & 日前方案 & 滚动方案\\\midrule
...
\begin{table}[H]\centering\caption{波动电价下典型日购电与费用汇总}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
日期 & 方案 & 原计划/kWh & 最终计划/kWh & 总费用/元 & 紧急购电/kWh\\\midrule
...
\par
\begin{table}[H]\centering\caption{波动电价下指定10分钟时段最终购电量（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 方案 & 03-20 & 06-21 & 09-23 & 12-21\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{波动电价下典型日储能量（充电/放电；末两行为首末储电量，kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
时间段 & 方案 & 03-20 & 06-21 & 09-23 & 12-21\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题四之二四个典型日紧急购电（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccccc}\toprule
03-20 & 购电量 & 06-21 & 购电量 & 09-23 & 购电量 & 12-21 & 购电量\\\midrule
...
\bottomrule\end{tabular}\end{adjustbox}\end{table}
\begin{table}[H]\centering\caption{问题四之三四个典型日紧急购电（kWh）}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccccc}\toprule
03-20 & 购电量 & 06-21 & 购电量 & 09-23 & 购电量 & 12-21 & 购电量\\\midrule
...
\par
\begin{table}[H]\centering\caption{保持日均价格的波动试验}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lccccc}\toprule
$\lambda$ & 日内CV均值 & 日前费用/万元 & 滚动费用/万元 & 节约/万元 & 节约率\\\midrule
...
\par
\begin{figure}[H]\centering
\includegraphics[width=\linewidth,height=5.3cm,keepaspectratio]{../new_figures_main/Q4_F4_rolling_gain_sensitivity.pdf}
\caption{保持日均价的五种波动情形下，滚动策略相对日前策略的费用节约与节约率。}\end{figure}
\section{8 模型检验与结果边界}
...
\par
\begin{table}[H]\centering\caption{实际运行与数值结果核验}
\fontsize{9.5}{12}\selectfont\setlength{\tabcolsep}{4pt}\renewcommand{\arraystretch}{1.12}
\begin{adjustbox}{max width=\linewidth}\begin{tabular}{lcc}\toprule
检验项目 & 结果 & 结论范围\\\midrule
...
\par
为保持正文可读，完整Python源代码另附于“附录B\_完整源代码.md”及“原始程序与结果.zip”，包括运行入口、公共优化器、各问模型、结果导出与验证程序；没有以省略号替代算法。压缩包保留原始目录关系，并包含原始输入附件、依赖清单和正式结果，复现应解压至独立目录按原入口执行。本文排版程序“构建论文.py”只读取既有数据生成文档，不运行或改写建模程序。
\par
